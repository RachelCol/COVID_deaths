...
combined_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 85 and over, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_75_to_84_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 75-84, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_65_to_74_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 65-74, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_55_to_64_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 55-64, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_45_to_54_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 45-54, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_35_to_44_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 35-44, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_25_to_34_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 25-34, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_15_to_24_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 15-24, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_5_to_14_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 5-14, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_1_to_4_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, ages 1-4, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
...
ages_under_1_chart <- ggplot() + 
  ...
  xlab('Weeks') +
  ylab('Deaths') +
  ggtitle("Deaths, under age 1, weeks ending 2/22/20 to 10/09/21, \n total (black) v. non-COVID (blue) v. COVID (red)")
